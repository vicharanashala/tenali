...
function saveDetectiveProgress(data) {
  try {
    localStorage.setItem(DETECTIVE_STORAGE_KEY, JSON.stringify(data))
  } catch {}
}
...
const ORIGINAL_CASES = [
  {
    ...
    description:
      'A cryptic equation was left at a crime scene. Decode it to find the next clue!',
    difficulty: 1,
    xpReward: 30,
    topic: 'lineareq',
    stages: [
      {
        title: 'Briefing',
        narrative:
          'Detective, we need your help! A mysterious note was found at the scene reading: "The sum of two consecutive numbers is 47." The next clue is hidden at the page number equal to the larger number. What is the larger number?',
        question:
          'Two consecutive numbers add up to 47. Find the larger number.',
        answer: 24,
        hints: [
          'Let the numbers be x and x+1.',
          'x + (x+1) = 47 → 2x + 1 = 47 → 2x = 46.',
          'x = 23, larger = 24.',
        ],
      },
      {
        title: 'Clue Analysis',
        narrative:
          'Great work! The book led you to a safe. The safe combination is the answer to: "Three times a number, minus 5, equals 28. What is the number?"',
        question: '3x − 5 = 28. Solve for x.',
        answer: 11,
        hints: ['Add 5: 3x = 33.', 'x = 11.'],
      },
      {
        title: 'Final Deduction',
        narrative:
          'The safe contained a final riddle: "Think of a number. Double it, add 10, then divide by 2. The result is 25. What was the original number?" The answer reveals the culprit!',
        question: 'Work backwards: (2x + 10) ÷ 2 = 25. Find x.',
        answer: 20,
        hints: [
          'Multiply both sides by 2: 2x + 10 = 50.',
          'Then 2x = 40 → x = 20.',
        ],
      },
    ],
  },
  {
    ...
    description:
      'A suspicious blueprint was found. Use geometry to measure the evidence!',
    difficulty: 1,
    xpReward: 40,
    topic: 'mensur',
    stages: [
      {
        ...
        narrative:
          'The blueprint shows a rectangular garden. The length is 12 metres and the width is 8 metres. The suspect wrote: "Perimeter = ?" on the edge. Find the perimeter to unlock the first clue.',
        question:
          'A rectangle has length 12m and width 8m. What is its perimeter?',
        answer: 40,
        hints: ['Perimeter = 2(l + w).', '2(12 + 8) = 2 × 20 = 40.'],
      },
      {
        title: 'Area Investigation',
        narrative:
          'Inside the garden, there is a square flower bed with side length 3 metres. The suspect planted something there. What is the area of the flower bed?',
        question: 'A square has side length 3m. Calculate its area.',
        answer: 9,
        hints: ['Area of square = side².', '3² = 9.'],
      },
      {
        title: 'The Big Reveal',
        narrative:
          'The remaining area of the garden (excluding the flower bed) was dug up. Find the area that was disturbed to discover what was hidden.',
        question: 'Garden area = 96m². Flower bed area = 9m². Remainder = ?',
        answer: 87,
        hints: ['Remainder = total garden area − flower bed.', '96 − 9 = 87.'],
      },
    ],
  },
  {
    ...
    description:
      'A recipe for disaster! Someone tampered with the measurements. Restore the correct quantities.',
    difficulty: 2,
    xpReward: 50,
    topic: 'fractionadd',
    stages: [
      {
        ...
        narrative:
          "The chef's recipe calls for 2/3 cup of sugar, but the tamperer changed it to 1/4 cup. How much more sugar is needed to fix the recipe?",
        question: '2/3 − 1/4 = ? (Give answer as a simplified fraction a/b)',
        answer: '5/12',
        hints: [
      ...
      },
      {
        ...
        narrative:
          'The corrected recipe makes 12 cookies. We need 30 cookies. Multiply all ingredients by what factor?',
        question: 'Scale factor = 30/12 = ? (simplified)',
        answer: '5/2',
        hints: [
          'Scale factor = new / old = 30/12.',
          'Simplify: divide by 6 → 5/2.',
        ],
      },
      {
        title: 'Final Check',
        narrative: 'The corrected sugar for 30 cookies: 2/3 × 5/2 = ?',
        question: '2/3 × 5/2 = ? (Simplify)',
        answer: '5/3',
        hints: [
          'Multiply numerators: 2×5=10, denominators: 3×2=6.',
          '10/6 = 5/3.',
        ],
      },
    ],
  },
  {
    ...
    description:
      'A speeding vehicle was caught on camera. Use speed-distance-time calculations!',
    difficulty: 2,
    xpReward: 60,
    topic: 'sdt',
    stages: [
      {
        ...
        narrative:
          "The suspect's car travelled 240 km in 3 hours. Speed limit was 60 km/h. Was the suspect speeding? Enter speed in km/h.",
        question: 'Speed = Distance ÷ Time. 240km ÷ 3h = ?',
        answer: 80,
        hints: ['Speed = 240 ÷ 3.', '= 80 km/h. Yes, speeding!'],
      },
      {
        title: 'Time Alibi',
        narrative:
          'The suspect claims they left at 2:30 PM and drove 150 km at 50 km/h. What time did they arrive?',
        question: 'Time = 150 ÷ 50 = ? hours. Add to 2:30 PM.',
        answer: 5.5,
        hints: ['150 ÷ 50 = 3 hours.', '2:30 + 3h = 5:30 PM = 5.5.'],
      },
      {
        title: 'Fuel Evidence',
        narrative:
          "The car's fuel tank holds 45 litres. It consumes 8 km per litre. How far can the suspect travel on a full tank?",
        question: 'Range = Fuel × Efficiency. 45 × 8 = ?',
        answer: 360,
        hints: ['45 × 8 = 360 km.'],
      },
    ],
  },
  {
    ...
    description:
      'A bank statement has been altered. Follow percentage changes to trace the stolen amount!',
    difficulty: 3,
    xpReward: 80,
    topic: 'percent',
    stages: [
      {
        ...
        narrative:
          'The victim deposited ₹2000. The statement shows 15% interest was added. What is the new balance?',
        question: '2000 + 15% of 2000 = ?',
        answer: 2300,
        hints: ['15% of 2000 = 300.', '2000 + 300 = 2300.'],
      },
      {
        title: 'The Withdrawal',
        narrative:
          'The suspect withdrew 20% of the balance. How much was withdrawn?',
        question: '20% of 2300 = ?',
        answer: 460,
        hints: ['20% = 0.2.', '0.2 × 2300 = 460.'],
      },
      {
        title: 'Money Trail',
        narrative:
          'After the withdrawal, the remaining balance was transferred. 80% of that transferred amount could be recovered. How much was recovered?',
        question: '80% of (2300 − 460) = ?',
        answer: 1472,
        hints: ['2300 − 460 = 1840.', '80% of 1840 = 0.8 × 1840 = 1472.'],
      },
    ],
  },
  {
    ...
    description:
      'A gambling den was raided. Use probability to identify the rigged game!',
    difficulty: 3,
    xpReward: 100,
    topic: 'prob',
    stages: [
      {
        title: 'Dice Game',
        narrative:
          'In a fair game, you roll a single six-sided die. What is the probability of rolling a number greater than 4?',
        question: 'P(>4) on a 6-sided die = ? (simplified fraction)',
        answer: '1/3',
        hints: ['Numbers > 4: 5, 6 (2 numbers).', 'P = 2/6 = 1/3.'],
      },
      {
        title: 'Card Trick',
        narrative: 'From a 52-card deck, what is P(heart)?',
        question: 'P(heart) from 52 = ?/?',
        answer: '1/4',
        hints: ['13 hearts in a deck.', '13/52 = 1/4.'],
      },
      {
        title: 'The Rigged Game',
        narrative:
          'An 8-sided die with 3 "win" sides and 5 "lose" sides. What is P(win)?',
        question: 'P(win) = 3/8',
        answer: '3/8',
        hints: ['3 winning sides out of 8.', 'P = 3/8.'],
      },
    ],
  },
  {
    ...
    description:
      'A mysterious triangle found at a crime scene. Use trigonometry to decode it!',
    difficulty: 2,
    xpReward: 70,
    topic: 'trig',
    stages: [
      {
        ...
        narrative:
          'Right triangle with angle 30°, hypotenuse 10 cm. Find the opposite side (sin 30° = 0.5).',
        question: 'Opposite = sin 30° × 10 = 0.5 × 10 = ?',
        answer: 5,
        hints: [
          'SOH: sin = opposite/hypotenuse.',
          'opposite = sin × hyp = 0.5 × 10 = 5.',
        ],
      },
      {
        title: 'Adjacent Clue',
        narrative: 'Find the adjacent side (cos 30° ≈ 0.866).',
        question: 'Adjacent = cos 30° × 10 = 0.866 × 10 = ? (1 d.p.)',
        answer: 8.7,
        hints: [
          'CAH: cos = adjacent/hypotenuse.',
          'adj = cos × hyp = 0.866 × 10 = 8.66 ≈ 8.7.',
        ],
      },
      {
        title: 'Height of Building',
        narrative:
          'From 50m from base, angle of elevation = 45°. tan 45° = 1. How tall is the building?',
        question: 'Height = 50 × tan 45° = 50 × 1 = ?',
        answer: 50,
        hints: ['TOA: tan = opposite/adjacent.', 'height = 50 × 1 = 50m.'],
      },
    ],
  },
  {
    ...
    description:
      'A data breach at the bank! Analyse numbers to identify fraud.',
    difficulty: 2,
    xpReward: 75,
    topic: 'stats',
    stages: [
      {
        ...
        narrative:
          'Five transactions: ₹100, 150, 200, 250, X. Mean = ₹200. Find X.',
        question: '(100+150+200+250+X) ÷ 5 = 200. Solve for X.',
        answer: 300,
        hints: ['Sum = 700 + X.', '(700+X)/5 = 200 → 700+X = 1000 → X = 300.'],
      },
      {
        title: 'Median Mystery',
        narrative: 'Sorted: 50, 80, 120, X, 200, 250. Median = 130. Find X.',
        question: 'Median = (120+X)/2 = 130. Find X.',
        answer: 140,
        hints: ['(120+X)/2 = 130.', '120+X = 260 → X = 140.'],
      },
    ],
  },
  {
    ...
    description: 'A coded message containing ratios. Crack the proportions!',
    difficulty: 1,
    xpReward: 45,
    topic: 'ratio',
    stages: [
      {
        ...
        narrative:
          'Two suspects split ₹300 in ratio 2:3. How much did the smaller share get?',
        question: 'Split 300 in ratio 2:3. Smaller = (2/5) × 300 = ?',
        answer: 120,
        hints: [
          'Total parts = 5.',
          'One part = 300 ÷ 5 = 60.',
      ...
      },
      {
        ...
        narrative:
          'Two solutions mixed in ratio 3:7. Total = 500ml. How much of the first solution?',
        question: 'First = 3 × (500 ÷ 10) = ?',
        answer: 150,
        hints: ['One part = 500 ÷ 10 = 50 ml.', 'First = 3 × 50 = 150 ml.'],
      },
    ],
  },
  {
    ...
    description:
      'The suspect left a trail of algebraic equations. Solve each one!',
    difficulty: 3,
    xpReward: 90,
    topic: 'basicarith',
    stages: [
      {
        title: 'Linear Trail',
        narrative: 'Solve: 5x − 3 = 2x + 12. The answer is the house number.',
        question: '5x − 3 = 2x + 12. Solve for x.',
        answer: 5,
        hints: ['5x − 2x = 12 + 3 → 3x = 15.', 'x = 5.'],
      },
      {
        title: 'Simultaneous Sightings',
        narrative: 'Solve: 2x + y = 10 and x − y = 2. y is the floor number.',
        question: '2x + y = 10 and x − y = 2. What is y?',
        answer: 2,
        hints: ['Add equations: 3x = 12 → x = 4.', '4 − y = 2 → y = 2.'],
      },
      {
        title: 'Quadratic Questioning',
        narrative: 'x² − 7x + 12 = 0. The larger root is the page number.',
        question: 'x² − 7x + 12 = 0. Larger root = ?',
        answer: 4,
        hints: ['Factor: (x−3)(x−4) = 0.', 'Roots: x=3, x=4. Larger = 4.'],
      },
    ],
  },
  {
    ...
    description:
      'A conspiracy involving prime numbers, factors, and multiples. Use number theory!',
    difficulty: 3,
    xpReward: 100,
    topic: 'primefactor',
    stages: [
      {
        title: 'Prime Suspect',
        narrative:
          "Sum of all primes between 10 and 20. That's the meeting room number.",
        question: 'Sum of primes between 10 and 20 (11,13,17,19) = ?',
        answer: 60,
        hints: ['Primes: 11, 13, 17, 19.', 'Sum = 60.'],
      },
      {
        title: 'Factor Finder',
        narrative:
          'Prime factorization of 84. Sum all prime factors (including repeats).',
        question: '84 = 2×2×3×7. Sum = 2+2+3+7 = ?',
        answer: 14,
        hints: ['84 = 2×42 = 2×2×21 = 2×2×3×7.', 'Sum = 14.'],
      },
      {
        title: 'LCM Lock',
        narrative: 'LCM of 6 and 15 is the next code.',
        question: 'LCM(6, 15) = ?',
        answer: 30,
        hints: [
...
function DetectiveCaseLibrary({
  ...
  return (
    <div className="app-shell">
      <div
        className="card"
        style={{ maxWidth: 'min(700px, 95vw)', margin: '0 auto' }}
      >
        <div
          style={{
            display: 'flex',
        ...
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          >
            {Object.keys(topicGroups).length} topics &middot; {cases.length}{' '}
            unique cases &middot; Press{' '}
            <kbd
              style={{
                padding: '1px 5px',
                borderRadius: 4,
        ...
        >
          ...
          {filteredCases.map((caseItem, idx) => {
            ...
            const topicDisplay = caseItem.topic
              ? caseItem.topic.charAt(0).toUpperCase() + caseItem.topic.slice(1)
              : 'General'
              ...
              >
                    ...
                    caseProgress.stars && (
                      ...
                      >
                        <span style={{ color: '#ff9800' }}>
                          {'⭐'.repeat(caseProgress.stars)}
                          {'☆'.repeat(3 - caseProgress.stars)}
                        </span>
                      </div>
                    )}
                </div>
                ...
                <div style={{ textAlign: 'right', flexShrink: 0 }}>
                  ...
                  {status === 'in_progress' && (
                    ...
                    >
                      Stage {caseProgress.currentStage + 1}/
                      {caseProgress.totalStages}
                    </div>
                  )}
                  {status === 'not_started' && (
...
function DetectiveCaseView({ caseData, initialStage, onComplete, onBack }) {
  ...
  function renderStars(hintLevel) {
    ...
    for (let i = 0; i < 3; i++) {
      stars.push(
        <span
          key={i}
          className={i < starCount ? 'mda-star' : ''}
          style={{
            fontSize: '1.8rem',
  ...
  useEffect(() => {
    if (
      revealed &&
      feedback?.correct &&
      stageIndex < caseData.stages.length - 1
    ) {
      playCorrectSound()
    }
  }, [revealed, stageIndex])
  ...
  if (completed) {
    ...
    return (
      <div className="app-shell">
        ...
        >
          <div
            className="mda-trophy mda-floatSlow"
          ...
          >
            <div
              className="mda-popIn mda-delay-1"
              style={{
                padding: '0.5rem 1rem',
                borderRadius: 12,
                background: 'var(--clr-surface)',
            ...
            >
              <div
                className="mda-countUp mda-delay-2"
                style={{
                  fontSize: '1.3rem',
                  fontWeight: 800,
                  color:
            ...
            <div
              className="mda-popIn mda-delay-2"
              style={{
                padding: '0.5rem 1rem',
                borderRadius: 12,
                background: 'var(--clr-surface)',
            ...
            >
              <div
                className="mda-countUp mda-delay-3"
                style={{
                  fontSize: '1.3rem',
                  fontWeight: 800,
                  color: 'var(--clr-accent)',
          ...
          >
            Excellent detective work! You cracked{' '}
          ...
          >
            {totalHintsUsed === 0 && (
              <span style={{ color: '#4caf50', fontWeight: 700 }}>
                🦅 No hints used across all stages — Masterful detective work!
              </span>
            )}
            {totalHintsUsed === 1 && (
              <span style={{ color: '#ff9800', fontWeight: 700 }}>
                💡 Used 1 hint total — try going solo next time for more stars!
              </span>
            )}
            {totalHintsUsed === 2 && (
              <span style={{ color: '#ff9800', fontWeight: 700 }}>
                💡 Used 2 hints total — try using fewer for more stars!
              </span>
            )}
            {totalHintsUsed >= 3 && (
              <span style={{ color: '#f44336', fontWeight: 700 }}>
                💡 Used {totalHintsUsed} hints total — challenge yourself to use
                fewer!
              </span>
            )}
          </div>
          <button
            onClick={onBack}
            className="mda-popIn mda-delay-4"
            style={{
              padding: '0.8rem 2rem',
              borderRadius: 12,
              border: 'none',
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                '0 6px 20px rgba(232,134,74,0.4)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'scale(1)'
              e.currentTarget.style.boxShadow =
                '0 4px 16px rgba(232,134,74,0.3)'
            }}
            onPointerDown={(e) => {
  ...
  if (!completed && !stage) return null
  ...
  return (
    <div className="app-shell">
      <div
        className="card"
        style={{ maxWidth: 'min(600px, 95vw)', margin: '0 auto' }}
      >
        <button
                ...
                background:
                  i < stageIndex
                    ...
                    : i === stageIndex
                      ...
                      : 'var(--clr-border)',
                transition:
                  'background 0.5s cubic-bezier(0.68, -0.55, 0.27, 1.55)',
                transform:
          ...
          {!revealed && hints.length > 0 && (
            <div style={{ marginBottom: '1rem' }}>
              ...
              >
                ...
                {hintLevel >= hints.length
                  ? 'No more hints'
                  : `Need a hint? (${hintLevel}/${hints.length} revealed)`}
              </button>
              {hintLevel > 0 && (
                <div
                  style={{
        ...
        {!revealed ? (
          ...
          <div
            ...
            style={{
              ...
              background:
                feedback && feedback.correct
                  ? 'var(--clr-correct-bg, rgba(76,175,80,0.12))'
          ...
          >
            ...
            {!feedback.correct && (
              ...
              >
                ...
                <strong>{feedback && feedback.correctAnswer}</strong>
              </div>
            )}
            {feedback &&
              feedback.correct &&
            ...
            <button
              ...
              style={{
                ...
                border: 'none',
                background:
                  feedback && feedback.correct ? '#4caf50' : '#e05a4a',
                color: '#fff',
                fontWeight: 600,
                cursor: 'pointer',
                fontSize: '0.9rem',
            ...
            >
              {feedback && feedback.correct
                ? stageIndex + 1 >= caseData.stages.length
                  ? 'Complete Case'
                  : 'Next Stage'
                : 'Try Again'}
            </button>
...
const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    title: 'Perfect Score',
    icon: '⭐',
    desc: 'Get 3 stars on a case',
    check: (p) => Object.values(p.cases || {}).some((c) => c.stars === 3),
  },
  {
    id: 'speed_demon',
    title: 'Speed Demon',
    icon: '🚀',
    desc: 'Solve 3 cases without hints',
    check: (p) =>
      Object.values(p.cases || {}).filter((c) => c.hintLevel === 0).length >= 3,
  },
  {
    id: 'veteran',
    title: 'Veteran',
  ...
  {
    id: 'diamond',
    title: 'Diamond Detective',
    icon: '💎',
    desc: 'Get 3 stars on 5 cases',
    check: (p) =>
      Object.values(p.cases || {}).filter((c) => c.stars === 3).length >= 5,
  },
  {
    id: 'scholar',
    title: 'Scholar',
    icon: '📚',
    desc: 'Solve cases from 10 topics',
    check: (p) => {
      const topics = new Set(Object.values(p.cases || {}).map((c) => c.topic))
        ...
        >
          <div
            style={{
              ...
              background: 'linear-gradient(90deg, #4caf50, #ff9800, #e8864a)',
        ...
        >
          {ACHIEVEMENTS.map((a, idx) => {
            ...
            return (
              <div
                key={a.id}
                className={`mda-achievement-card ${isUnlocked ? 'mda-badgeReveal' : ''} mda-delay-${(idx % 6) + 1}`}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  gap: '0.8rem',
              ...
              >
                <div
                  style={{
                    ...
                    justifyContent: 'center',
                    background: isUnlocked
                      ? 'var(--accent-soft, rgba(232,134,74,0.12))'
                      : 'transparent',
                    flexShrink: 0,
                  }}
                >
...
function updateLeaderboard(caseId, stars, xp, hintLevel, topic) {
  ...
  if (
    ...
    (stars === existing.stars && xp > existing.xp)
  ) {
  ...
  if (data.bestScores.length > 20)
    data.bestScores = data.bestScores.slice(0, 20)
...
function DetectiveLeaderboard({ onBack, progress, totalCases, caseLookup }) {
  ...
  if (sortBy === 'stars') {
    entries.sort(
      (a, b) =>
        (b[1].stars || 0) - (a[1].stars || 0) || (b[1].xp || 0) - (a[1].xp || 0)
    )
  } else if (sortBy === 'xp') {
    entries.sort(
      (a, b) =>
        (b[1].xp || 0) - (a[1].xp || 0) || (b[1].stars || 0) - (a[1].stars || 0)
    )
  } else {
  ...
  const totalBestStars = Object.values(leaderData.byCase).reduce(
    (s, v) => s + (v.stars || 0),
    0
  )
  ...
  return (
    <div className="app-shell">
      <div
        className="card"
        style={{ maxWidth: 'min(650px, 95vw)', margin: '0 auto' }}
      >
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          >
            <div
              style={{ fontSize: '1.3rem', fontWeight: 800, color: '#ff9800' }}
            >
              {totalBestStars}/{possibleStars}
            </div>
            <div
              style={{
                fontSize: '0.65rem',
          ...
          >
            ...
            >
              {Object.keys(leaderData.byCase).length}
            </div>
            <div
              style={{
                fontSize: '0.65rem',
              ...
              style={{
                ...
                border:
                  sortBy === s
                    ...
                    : '1.5px solid var(--clr-border)',
                background:
                  sortBy === s ? 'var(--clr-accent-soft)' : 'transparent',
                color:
                  sortBy === s ? 'var(--clr-accent)' : 'var(--clr-text-soft)',
                cursor: 'pointer',
                fontSize: '0.78rem',
                fontWeight: 600,
                transition: 'all 0.2s',
        ...
        >
          ...
          {entries.map(([id, data], i) => (
            <div
              key={id}
              className={`mda-leaderboard-row mda-delay-${(i % 8) + 1}`}
              style={{
                display: 'flex',
                alignItems: 'center',
                gap: '0.8rem',
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div
                  style={{ fontSize: '0.7rem', color: 'var(--clr-text-soft)' }}
                >
                  📚 {data.topic || 'general'} &middot;{' '}
...
export default function EnhancedMathDetectiveApp({ onBack }) {
  ...
  const xpProgressPct = nextRank
    ? Math.min(
        100,
        Math.round(((progress.xp - rank.xp) / (nextRank.xp - rank.xp)) * 100)
      )
    : 100
  ...
  useEffect(() => {
    const unfinishedCase = Object.entries(progress.cases || {}).find(
      ([, p]) => p.status === 'in_progress'
    )
    const hasAnyCaseStarted = Object.keys(progress.cases || {}).length > 0
    const allComplete =
      hasAnyCaseStarted &&
      ALL_CASES.every((c) => progress.cases[c.id]?.status === 'solved')
  ...
  const handleCaseComplete = (caseId, solved, meta = {}) => {
    ...
    updated.casesSolved = Object.values(updated.cases).filter(
      (c) => c.status === 'solved'
    ).length
    ...
    const newlyUnlocked = checkAndAwardAchievements(tempProgress)
  ...
  const handleReset = () => {
    const msg =
      'Reset all detective progress? This will clear all solved cases, XP, stars AND leaderboard data.'
    ...
    return (
      <>
        <AchievementNotification
          ...
          onDismiss={dismissAchievementNotif}
        />
        <DetectiveAchievements
  ...
  if (screen === 'case' && activeCaseId) {
    ...
    const initialStage =
      caseProgress && caseProgress.status === 'in_progress'
  ...
  if (screen === 'library') {
    ...
    const allComplete =
      hasAnyStarted &&
      ageFilteredCases.every(
        (c) => (progress.cases || {})[c.id]?.status === 'solved'
      )
      ...
      <div className="app-shell">
        ...
        >
                  ...
                  style={{
                    ...
                    border:
                      userAge === a
                        ...
                        : '1.5px solid var(--clr-border)',
                    background:
                      userAge === a ? 'var(--clr-accent-soft)' : 'transparent',
                    color:
                      userAge === a
                        ? 'var(--clr-accent)'
                        : 'var(--clr-text-soft)',
          ...
          >
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  '0 6px 24px rgba(232,134,74,0.4)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'scale(1)'
                e.currentTarget.style.boxShadow =
          ...
          >
            ...
            >
              🕵️ <strong>{totalCases}</strong> age-appropriate cases across{' '}
              <strong>{uniqueTopics}</strong> math topics
              <br />
              💡 Each question has progressive hints to help you
              <br />
              🔄 No two cases are the same — multiple story variants per topic
              <br />
              🎂 <strong>Age {userAge}</strong> —{' '}
              <strong>{getAgeClassLabel(userAge)}</strong>
              {totalCases === 0 && (
                <>
                  <br />
                  📚 <strong>UKG cases coming soon!</strong> Check back for
                  counting, shapes & pattern stories
                </>
              )}
              <br />
              🏆 Earn <strong>3 stars ⭐⭐⭐</strong> by solving without hints!
            </div>
          </div>
