 ...
 * TeacherLayout.jsx
 *
 * Layout wrapper for all teacher-specific pages.
 * Features a sticky header with teacher-specific navigation,
 * session validation, and a slot for child routes.
 *
 * Routes wrapped by this layout:
 *   /teacher              — Teacher dashboard (cohort overview)
 *   /teacher/cohort/:id   — Cohort detail page
 *   /teacher/student/:id  — Individual student analytics
 *   /teacher/alerts       — Alert management
...
// Session storage key — mirrors App.jsx
      ...
      <header className="sticky top-0 z-50 px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between bg-navy-900/60 backdrop-blur-xl border border-white/10 px-5 py-3 rounded-2xl shadow-2xl">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 bg-gradient-to-br from-amber-400 to-amber-600 rounded-xl flex items-center justify-center rotate-3 shadow-lg shadow-amber-400/20">
            ...
            <span className="hidden sm:inline-block ml-2 px-2.5 py-0.5 bg-amber-400/20 text-amber-400 text-xs font-mono font-semibold rounded-full border border-amber-400/30">
              Teacher
            </span>
          </div>
          ...
          <nav aria-label="Teacher navigation" className="hidden md:flex items-center gap-1">
            <NavLink to="/teacher">My Cohorts</NavLink>
            <NavLink to="/teacher/content">Content</NavLink>
            <NavLink to="/teacher/analytics">Analytics</NavLink>
            <NavLink to="/teacher/alerts">Alerts</NavLink>
          </nav>

          {/* Right side: user info + sign-out */}
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-gradient-to-br from-amber-400 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg">
